...
EDLineDetector::~EDLineDetector(){
//	cout<<pFirstPartEdgeX_<<endl;
//	cout<<NULL<<endl;
	if(pFirstPartEdgeX_!=NULL){
		delete [] pFirstPartEdgeX_;
//		cout<<"pFirstPartEdgeX_"<<endl;
		delete [] pFirstPartEdgeY_;
//		cout<<"pFirstPartEdgeY_"<<endl;
		delete [] pSecondPartEdgeX_;
//		cout<<"pSecondPartEdgeX_"<<endl;
		delete [] pSecondPartEdgeY_;
//		cout<<"pSecondPartEdgeY_"<<endl;
		delete [] pAnchorX_;
//		cout<<"pAnchorX_"<<endl;
		delete [] pAnchorY_;
//		cout<<"pAnchorY_"<<endl;
	}
//	cout<<pFirstPartEdgeS_<<endl;
//	cout<<NULL<<endl;
//	cout<<pFirstPartEdgeS_[0]<<endl;
	if(pFirstPartEdgeS_ != NULL){
		delete [] pFirstPartEdgeS_;
//		cout<<"pFirstPartEdgeS_ "<<pFirstPartEdgeS_<<endl;
		delete [] pSecondPartEdgeS_;
//		cout<<"pSecondPartEdgeS_ "<<pSecondPartEdgeS_<<endl;
	}
}
...
//	cout<<"lines.xCors.size()="<<lines.xCors.size()<<endl;
//	cout<<"lines.yCors.size()="<<lines.yCors.size()<<endl;
//	cout<<"lines.sId.size()="<<lines.sId.size()<<endl;
...
//	cout<<"edges.numOfEdges="<<edges.numOfEdges<<endl;
...
//		cout<<"offsetInEdgeArrayS="<<offsetInEdgeArrayS<<endl;
//		cout<<"offsetInEdgeArrayE="<<offsetInEdgeArrayE<<endl;
//		cout<<"offsetInEdgeArrayS+minLineLen_="<<offsetInEdgeArrayS+minLineLen_<<endl;
...
//	cout<<"pLineSID[numOfLines]="<<pLineSID[numOfLines]<<endl;
//	cout<<"lines.numOfLines="<<lines.numOfLines<<endl;
...
//	cout<<"lines_.numOfLines="<<lines_.numOfLines<<endl;
	lineSalience_.clear();
