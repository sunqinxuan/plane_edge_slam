...
{
//	cout<<"image_process "<<img1path<<" "<<img2path<<endl;
    ...
    //leftImage  = imread("/media/sun/Elements/sun/rgbd_dataset_freiburg3_cabinet/rgb/1341841279.982535.png", cv::IMREAD_GRAYSCALE);
    //rightImage = imread("/media/sun/Elements/sun/rgbd_dataset_freiburg3_cabinet/rgb/1341841280.314599.png", cv::IMREAD_GRAYSCALE);
    rightImage = imread("/media/sun/Elements/sun/rgbd_dataset_freiburg3_cabinet/rgb/1341841279.982535.png", cv::IMREAD_GRAYSCALE);
    leftImage  = imread("/media/sun/Elements/sun/rgbd_dataset_freiburg3_cabinet/rgb/1341841280.314599.png", cv::IMREAD_GRAYSCALE);
    ...
    unsigned int imageWidth = rightImage.cols; //图片的宽与高
    unsigned int imageHeight = rightImage.rows;
...
//	cv::imshow("img",leftImage);
//	cv::imshow("img_color",leftColorImage);
//	cv::waitKey();
...
//	cout<<(unsigned int*)leftImage.data<<endl;
//	cout<<(unsigned int*)rightImage.data<<endl;
    ///////////####################################################################
    ///////////####################################################################
...
//	cv::imshow("img_color",rightImage);
//	cv::waitKey();
	...
	cv::imshow("img_color",rightColorImage);
	cv::waitKey();


    lineDesc.GetLineDescriptor(leftImage, linesInLeft);
//	cv::imshow("img_color",leftImage);
//	cv::waitKey();
...
//	cout<<(unsigned int*)rightImage.data<<endl;
    ...
    cv::imshow("img_color", cvResultColorImage);
	cv::waitKey();
