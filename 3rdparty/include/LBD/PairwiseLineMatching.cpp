...
//	cout << "the number of possible matched line pair = " << nodesList_.size() << endl;
	 ...
	 */
//	ofstream fp; fp.open("line_matching.txt");
//	fp<<"dim="<<dim<<endl;
//	fp<<"nnz="<<nnz<<endl;
//	fp<<endl<<"adjacenceMat"<<endl;
//	for(int i=0;i<nnz;i++) fp<<adjacenceMat[i]<<endl;
//	fp<<endl<<"irow"<<endl;
//	for(int i=0;i<nnz;i++) fp<<irow[i]<<endl;
//	fp<<endl<<"pcol"<<endl;
//	for(int i=0;i<dim+1;i++) fp<<pcol[i]<<endl;
